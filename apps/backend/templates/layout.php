...
<?php } ?>
	...
	jQuery('#company_vat_no').blur(function(){
		...
		jQuery.post("http://wls2.zerocall.com/backend.php/company/vat",{ vat_no:val } ,function(data)
        {//alert(data);
		...
		jQuery.post("http://wls2.zerocall.com/backend.php/employee/mobile",{ mobile_no: val} ,function(data)
        {
		  if(data=='no') //if username not avaiable
		  {
		  	jQuery("#msgbox").fadeTo(200,0.1,function() //start fading the messagebox
