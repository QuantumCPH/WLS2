...
<table width="600px">
 ...
 <td colspan="4" align="right" style="text-align:right; border:0px solid #fff"><?php echo image_tag('http://wls2.zerocall.com/images/zapna_logo_small.jpg');?></td>
    </tr>
</table>
<table class="receipt" cellspacing="0" width="600px">
  ...
  <tr class="footer"> 
    ...
    <td>&nbsp;</td>
    <td><?php echo format_number($subtotal) ?> dkk</td>
  </tr>
  <tr class="footer"> 
    <td>&nbsp;</td>
    <td><?php echo __('VAT') ?> (<?php echo $vat==0?'0%':'25%' ?>)</td>
    <td>&nbsp;</td>
    <td><?php echo format_number($vat) ?> dkk</td>
  </tr>
  <?php 
  ...
  <tr class="footer">
    ...
    <td>&nbsp;</td>
    <td><?php if($postalcharge && $order->getIsFirstOrder()){ echo format_number($transaction->getAmount()+$postalcharge); }else{ echo format_number($transaction->getAmount()); } ?> dkk</td>
...
<p>
	...
	<a href="mailto:zapna.no">support@zapna.no</a>
</p>
